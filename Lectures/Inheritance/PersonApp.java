...
public void actionPerformed(ActionEvent ae)
{
	...
	if(objSource ==btnAdd)
	{
		...
		if(personCount < studentInfo.length)
		{
		...
		studentInfo[personCount] = new Student(txtLName.getText(),
				txtFName.getText(),txtAddress.getText(),txtCity.getText(),
	   				txtState.getText(),txtZip.getText(),
	   				txtPhone.getText(), Double.parseDouble(txtGPA.getText()));
       ...
       else if(objSource == btnDisplay)
       {
    	   ...
    	   {
    		   messageString += "Name: " + studentInfo[i].getFName() + "  "
    				   + studentInfo[i].getLName() +"  "
				+	"Phone: " + studentInfo[i].getPhone() + "  " + "GPA: " + studentInfo[i].getGPA() 	 + "\n";
